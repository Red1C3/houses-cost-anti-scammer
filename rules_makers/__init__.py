...
def and_rule(sqft_living,sqft_lot,sqft_basement,view,bedrooms,bathrooms,floors,condition,distance,price,input_vars,output_var):
...
def and_rule2(sqft_living,amenities,distance,price,input_vars,output_var):
    return ctrl.Rule(input_vars['sqft_living'][sqft_living] & input_vars['amenities'][amenities] & input_vars['distance'][distance],output_var[price])